        ...
        <div className="space-y-2">
          ...
          <div className="grid gap-2">
            {selectedFiles.map((file, index) => (
              <div key={`${file.name}-${index}`} className="flex items-center justify-between p-3 bg-gray-50 rounded-lg border border-gray-100 group animate-in slide-in-from-top-1 duration-200 min-w-0">
